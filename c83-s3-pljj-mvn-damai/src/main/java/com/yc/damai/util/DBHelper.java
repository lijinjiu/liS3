...
public class DBHelper {
	...
	static {
		try {
			...
			Class.forName("com.mysql.jdbc.Driver");  //按住Ctrl+鼠标 变成手标
	...
	public Connection openConnection() {
		...
		String url = "jdbc:mysql://127.0.0.1/c83-s2-pljj-damai?useUnicode=true&characterEncoding=UTF-8" ; // 数据库的地址
